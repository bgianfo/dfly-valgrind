...
/*--------------------------------------------------------------------*/
/*--- DragonFlyBSD specific kernel interface.        vki-dflybsd.h ---*/
/*--------------------------------------------------------------------*/
...
#ifndef __VKI_DFLYBSD_H
#define __VKI_DFLYBSD_H
...
/* Proper definition of st_*timespc */
...
#define VKI_MSG_NOSIGNAL 	0 /* Disable it since it isn't supported in dfly */
